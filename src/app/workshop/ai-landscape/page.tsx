...
import { ArrowRight, ArrowLeft, Terminal, Brain, Sparkles, Database, Network, Cpu, Bot, CheckCircle2 } from "lucide-react";
          ...
          <AnimatePresence mode="wait">
            {activeData && (
              <motion.div
                ...
                className="h-full"
              >
                <Card className="h-full border-primary/20 bg-card/50 backdrop-blur-sm shadow-xl">
                  <CardHeader className="border-b border-border/50 pb-6 bg-muted/20">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        <div className="text-sm font-mono text-primary font-semibold">{activeData.year}</div>
                        <CardTitle className="text-3xl">{activeData.title}</CardTitle>
                      </div>
                    </div>
                  ...
                  <CardContent className="pt-6 space-y-6">
                    ...
                    <div className="p-4 rounded-lg bg-secondary/50 border border-border/50">
                      <h4 className="text-sm font-semibold uppercase tracking-wider text-foreground mb-2 flex items-center gap-2">
